...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="{{ route('client.support.create') }}" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <a href="{{ route('client.messages.index') }}?filter=support" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
            ...
            <a href="{{ route('client.support.contact') }}" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-sm text-gray-500">Formulaire de contact rapide</p>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location.href='{{ route('client.messages.index') }}?filter=support'">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('client.support.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
