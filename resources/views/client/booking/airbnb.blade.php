            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-2xl border border-gray-200 p-6 sticky top-8">
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <a href="{{ route('public.agency.show', $car->agency) }}" class="text-sm text-blue-600 underline">
                            {{ $car->agency->agency_name }}
                        </a>
                    </div>
                    <a href="{{ route('public.agency.show', $car->agency) }}#reviews" class="flex items-center mb-4 text-sm text-gray-700 hover:text-gray-900">
                        <svg class="w-4 h-4 text-yellow-400 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                        </svg>
                        <span>{{ __('booking.airbnb.summary.reviews', ['rating' => number_format($car->getAverageRating(), 1), 'count' => $car->getReviewsCount()]) }}</span>
                    </a>
                    ...
                    <div class="border-t border-gray-200 pt-4 mb-4">
                        ...
                        <a href="{{ route('public.policies.non-refundable') }}" class="text-xs text-blue-600 underline cursor-pointer">
                            {{ __('booking.airbnb.summary.full_policy') }}
                        </a>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">
                                    {{ trans_choice('booking.airbnb.summary.days', $days, ['count' => $days]) }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-600">
                                    {{ $days }} {{ trans_choice('booking.airbnb.summary.days', $days, ['count' => $days]) }} × {{ number_format($pricePerDay, 0, ',', ' ') }} MAD
                                </span>
                                <span class="text-gray-900">{{ number_format($totalPrice, 0, ',', ' ') }} MAD</span>
                            </div>
