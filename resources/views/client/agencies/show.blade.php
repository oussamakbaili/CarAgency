...
@section('header', $agency->user->name)
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6">
    <div class="p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">{{ $agency->user->name }}</h1>
                <p class="text-gray-600 mt-1">{{ $agency->city ?? 'Localisation non spécifiée' }}</p>
            </div>
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg mb-6">
    <div class="p-6">
        ...
        <form method="GET" action="{{ route('client.agencies.show', $agency) }}" class="space-y-6" id="agencyCarsFiltersForm">
            <!-- Main Search -->
            <div class="relative">
...
<div class="bg-white overflow-hidden shadow-sm rounded-lg">
    <div class="p-12 text-center">
        ...
        <p class="text-gray-600 mb-6">Cette agence n'a pas de véhicules disponibles pour le moment.</p>
        <div class="space-x-4">
...
function clearFilters() {
    ...
    document.getElementById('agencyCarsFiltersForm').submit();
}
