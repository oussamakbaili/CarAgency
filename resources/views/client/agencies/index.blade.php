...
@section('title', 'Agences de Location')
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Agences de Location</h1>
                    <p class="text-gray-600 mt-2">Découvrez les meilleures agences de location de véhicules</p>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="text-right">
                        <div class="text-2xl font-bold text-blue-600">{{ $agencies->total() }}</div>
                        <div class="text-sm text-gray-500">agences disponibles</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-lg font-semibold text-gray-900">Rechercher une Agence</h2>
                ...
                <form method="GET" action="{{ route('client.agencies.index') }}" class="space-y-4">
                    <!-- Main Search -->
                    <div class="relative">
                    ...
                    <div id="filtersGrid" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <select id="min_rating" name="min_rating" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="text-center p-3 bg-gray-50 rounded-lg">
                            <div class="text-lg font-bold text-blue-600">{{ $agency->cars_count }}</div>
