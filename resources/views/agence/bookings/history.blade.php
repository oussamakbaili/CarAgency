        ...
        <form method="GET" action="{{ route('agence.bookings.history') }}" class="space-y-4">
            <div class="flex flex-wrap items-end gap-4">
                <div class="flex-1 min-w-48">
                    ...
                    <select name="status" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#0A66C2] focus:border-[#0A66C2]">
                ...
                <div class="flex-1 min-w-48">
                    ...
                    <select name="period" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#0A66C2] focus:border-[#0A66C2]">
                ...
                <div class="flex-1 min-w-48">
                    ...
                    <input type="text" 
                           ...
                           class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-[#0A66C2] focus:border-[#0A66C2]">
                </div>
                ...
                <div class="flex items-end space-x-2">
                    <button type="submit" class="px-4 py-2 bg-[#0A66C2] text-white rounded-md hover:bg-[#0A66C2] text-sm transition-colors duration-200">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('agence.bookings.history', array_merge(request()->all(), ['export' => 'csv'])) }}" 
               class="inline-flex items-center px-4 py-2 bg-[#0A66C2] text-white rounded-md hover:bg-[#0A66C2] text-sm transition-colors duration-200">
