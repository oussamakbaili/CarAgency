                    ...
                    <div class="flex items-center justify-center">
                        <div class="text-center max-w-4xl w-full">
                            ...
                            <div class="flex justify-center items-center space-x-2 md:space-x-4 mb-10">
                                ...
                                <!-- Connector 1 -->
                                <div class="w-12 md:w-20 h-1 bg-gradient-to-r from-green-400 to-[#0A66C2]"></div>
                                
                                <!-- Step 2: En Révision -->
                                <div class="flex items-center">
                                    <div class="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#0A66C2] to-[#0A66C2] rounded-full flex items-center justify-center shadow-lg animate-pulse">
                                        <svg class="w-5 h-5 md:w-6 md:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                        </svg>
                                    </div>
                                    <span class="ml-2 text-xs md:text-sm font-semibold text-[#0A66C2]">En Révision</span>
                                </div>
                            ...
                            <!-- Status Icon -->
                            <div class="mb-8">
                                <div class="mx-auto w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-[#0A66C2]/10 to-[#0A66C2]/10 rounded-full flex items-center justify-center border-4 border-[#0A66C2]/20">
                                    <svg class="h-12 w-12 md:h-14 md:w-14 text-[#0A66C2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Estimated Time -->
                            <div class="bg-gradient-to-br from-[#0A66C2]/10 to-[#0A66C2]/5 rounded-2xl border border-[#0A66C2]/20 p-6 mb-8 shadow-sm">
                                <div class="flex items-center justify-center space-x-3">
                                    <div class="flex items-center justify-center w-10 h-10 bg-[#0A66C2] rounded-full">
                                        <svg class="h-5 w-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                        </svg>
                                    </div>
                                    <p class="text-[#0A66C2] font-semibold text-base md:text-lg">
                            ...
                            <!-- Required Documents -->
                            <div class="bg-gradient-to-br from-[#0A66C2]/5 to-[#0A66C2]/5 rounded-2xl border border-[#0A66C2]/20 p-6 md:p-8 mb-8 shadow-sm">
                                        ...
                                        <ul class="space-y-3 text-gray-700">
                                            <li class="flex items-start">
                                                <div class="flex-shrink-0 mt-0.5">
                                                    <svg class="h-5 w-5 text-[#0A66C2] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-200 p-6 md:p-8 shadow-sm">
                                ...
                                <div class="flex flex-col sm:flex-row justify-center gap-4">
                                    <a href="{{ route('agence.support.create') }}" class="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-[#0A66C2] to-[#0A66C2] text-white rounded-xl hover:shadow-lg transform hover:scale-105 transition duration-200 font-semibold">
                                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                        </svg>
                                        Contacter le Support
                                    </a>
                                    <a href="#" class="inline-flex items-center justify-center px-6 py-3 bg-white border-2 border-gray-300 text-gray-700 rounded-xl hover:border-[#0A66C2] hover:text-[#0A66C2] transition duration-200 font-semibold">
                                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
