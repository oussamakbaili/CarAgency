    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6 reveal-section">
            ...
            <div class="p-4 sm:p-6">
                    ...
                    <div class="ml-3 sm:ml-4 flex-1">
                        <h2 class="text-xs sm:text-sm font-medium text-gray-600">Total</h2>
                        <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $statistics['total'] }} agences</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-4 sm:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4 flex-1">
                            ...
                            <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $statistics['pending'] }} agences</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-4 sm:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4 flex-1">
                            <h2 class="text-xs sm:text-sm font-medium text-gray-600">Approuvées</h2>
                            <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $statistics['approved'] }} agences</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                <div class="p-4 sm:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 sm:ml-4 flex-1">
                            <h2 class="text-xs sm:text-sm font-medium text-gray-600">Rejetées</h2>
                            <p class="text-xl sm:text-2xl font-bold text-gray-900">{{ $statistics['rejected'] }} agences</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg mb-4 sm:mb-6 reveal-section">
            <div class="p-4 sm:p-6">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
                    <h2 class="text-base sm:text-lg md:text-xl font-semibold text-gray-900">Liste des Agences</h2>
                    <div class="flex flex-wrap gap-2 sm:gap-3">
                        <a href="{{ route('admin.agencies.index') }}" 
                           class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 border border-gray-300 rounded-lg font-medium text-xs text-gray-700 hover:bg-gray-200 transition-colors">
                            Tous
                        </a>
                        <a href="{{ route('admin.agencies.index', ['status' => 'pending']) }}" 
                           class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-yellow-100 border border-yellow-300 rounded-lg font-medium text-xs text-yellow-700 hover:bg-yellow-200 transition-colors">
                            En Attente
                        </a>
                        <a href="{{ route('admin.agencies.index', ['status' => 'approved']) }}" 
                           class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-green-100 border border-green-300 rounded-lg font-medium text-xs text-green-700 hover:bg-green-200 transition-colors">
                            Approuvées
                        </a>
                        <a href="{{ route('admin.agencies.index', ['status' => 'rejected']) }}" 
                           class="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-red-100 border border-red-300 rounded-lg font-medium text-xs text-red-700 hover:bg-red-200 transition-colors">
                            Rejetées
                        </a>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Agence</th>
                                <th class="px-4 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Responsable</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-4 sm:px-6 py-3 sm:py-4">
                                    <div class="text-xs sm:text-sm font-medium text-gray-900">{{ $agency->agency_name }}</div>
                                    <div class="text-xs sm:text-sm text-gray-500">RC: {{ $agency->commercial_register_number }}</div>
                                </td>
                                <td class="px-4 sm:px-6 py-3 sm:py-4">
                                    <div class="text-xs sm:text-sm text-gray-900">{{ $agency->responsable_name }}</div>
                                    <div class="text-xs sm:text-sm text-gray-500">{{ $agency->responsable_position }}</div>
                                </td>
                                <td class="px-4 sm:px-6 py-3 sm:py-4">
                                    <div class="text-xs sm:text-sm text-gray-900">{{ $agency->email }}</div>
                                ...
                                <td class="px-4 sm:px-6 py-3 sm:py-4 text-right text-xs sm:text-sm font-medium">
                                    <div class="flex space-x-1 sm:space-x-2 justify-end" style="pointer-events: auto !important;">
                                        @if($agency->status === 'pending')
                                            <button type="button" 
                                                    class="approve-btn inline-flex items-center px-2 sm:px-3 py-1 bg-blue-600 text-white text-xs rounded-md"
                                            ...
                                            <button type="button" 
                                                    class="reject-btn inline-flex items-center px-2 sm:px-3 py-1 bg-red-600 text-white text-xs rounded-md"
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="px-4 sm:px-6 py-4 text-center text-xs sm:text-sm text-gray-500">
