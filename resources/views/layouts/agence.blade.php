...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-50">
            <!-- Sidebar -->
            <div id="sidebar-agency" class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-out z-40 lg:z-0">
            ...
            <div class="lg:pl-64 pl-0">
                ...
                <header class="bg-white border-b border-gray-200 sticky top-0 z-30">
                    <div class="px-4 sm:px-6 lg:px-8 py-4 lg:py-5">
                        <div class="flex items-center justify-between">
                            <!-- Mobile hamburger -->
                            <button id="open-sidebar-agency" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus:outline-none lg:hidden" aria-label="Ouvrir le menu">
        ...
        <div id="overlay-agency" class="fixed inset-0 z-30 bg-gray-900/60 backdrop-blur-sm hidden lg:hidden"></div>
        ...
        <script>
            (function(){
                const sidebar = document.getElementById('sidebar-agency');
                const overlay = document.getElementById('overlay-agency');
                const openBtn = document.getElementById('open-sidebar-agency');
                function open(){
        ...
        <nav class="lg:hidden fixed bottom-0 inset-x-0 z-30 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/70 border-t border-gray-200">
            <div class="flex justify-between px-2 pt-1 pb-[calc(env(safe-area-inset-bottom)+6px)]">
                <a href="{{ route('agence.dashboard') }}" class="flex-1 flex flex-col items-center gap-0.5 py-2 {{ request()->routeIs('agence.dashboard') ? 'text-orange-600' : 'text-gray-500' }}">
                ...
                <a href="{{ route('agence.cars.index') }}" class="flex-1 flex flex-col items-center gap-0.5 py-2 {{ (request()->routeIs('agence.cars.*') || request()->routeIs('agence.fleet.*')) ? 'text-orange-600' : 'text-gray-500' }}">
                    ...
                    <span class="text-[11px] font-medium">Flotte</span>
                </a>
                <a href="{{ route('agence.bookings.index') }}" class="flex-1 flex flex-col items-center gap-0.5 py-2 {{ (request()->routeIs('agence.bookings.*') || request()->routeIs('agence.rentals.*')) ? 'text-orange-600' : 'text-gray-500' }}">
                ...
                <a href="{{ route('agence.messages.index') }}" class="flex-1 flex flex-col items-center gap-0.5 py-2 {{ request()->routeIs('agence.messages.*') ? 'text-orange-600' : 'text-gray-500' }}">
                ...
                <a href="{{ route('agence.profile.index') }}" class="flex-1 flex flex-col items-center gap-0.5 py-2 {{ request()->routeIs('agence.profile.*') ? 'text-orange-600' : 'text-gray-500' }}">
