                            ...
                            @auth
                                @if(auth()->user()->role === 'client')
                                    ...
                                    <div class="py-2">
                                        ...
                                        <a href="{{ route('public.messages') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                                            <svg class="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a href="{{ route('client.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 hover:bg-gray-50 transition-colors">
                                            <svg class="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                            </svg>
                                            <span class="text-sm font-medium text-gray-700">Mon compte</span>
                                        </a>
